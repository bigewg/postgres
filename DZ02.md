...
**Новый уровень изоляции транзакции:**
```
...
```
** У нас открыто 2 сессии с уровнем read committed. В одной мы добавляем новую запись с таблицу persons, не делая commit. В другой делаем выборку из этой же таблицы.**
```
